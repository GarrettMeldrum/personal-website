    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      <header className="text-center mb-12">
        ...
        <p className="text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">
          I&apos;m passionate about learning and growing as a programmer. I plan
          to seek higher education to pursue my passion of computer science. In
          my freetime, I enjoy climbing, mountaineering, cooking, and
          homebrewing.
        </p>
      </header>
          ...
          {loading ? (
            ...
            <div>
              {mountaineeringTrips.map((trip) => (
                <Link key={trip.id} href={`/mountaineering/${trip.id}`}>
