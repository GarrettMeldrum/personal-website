export const projects = [
  {
    ...
    description:
      "My personal website is being self-hosted and served locally. This website is utilizing React/Next.js as a framework and uses Nginx to expose it to the internet.",
    tech: ["React", "Next.js", "Typescript", "APIs", "Self-Hosting", "Nginx"],
    link: "https://github.com/GarrettMeldrum/personal-website",
    featured: true,
  },
  {
    id: 2,
    ...
    description:
      "This is an orchestration of bots that monitor and execute purchases for specific brands matchas. The bot will automatically terminate when one of the slave bots successfully executes a purchase.",
  ...
  },
  {
    ...
    description:
      "Utilizing the Spotify API to capture listening data to a database. Then, this is reserved with analytics by a Python flask API that I utilizing in my applications.",
